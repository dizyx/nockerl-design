 ...
 *
 * - **The Banner inline-alert anatomy (adjudication addendum 2026-07-04, ;
 *   supersedes the r4 recessed well AND the r5 tinted lift).** A NEUTRAL
...
fun NockerlFailedTurn(
    ...
    NockerlSurface(
        ...
        // Light; adjudication addendum 2026-07-04). The banner material supplies
